...
Vison is the most prominent research area due to the fact that road signs/markings are made for human vision. LIDAR and GPS are important compliments for reaching full autonomous driving.\\
...
With this use case in mind, here are 5 requirements that should be fulfilled:
1
2
3
4
